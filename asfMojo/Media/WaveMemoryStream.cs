...
{
    /// <summary>
    /// In memory wave stream based on PCM samples and WAVE format passed in.
    /// The memory stream i.e. can be used to write to a file or for playback with SoundPlayer
    /// </summary>
    public class WaveMemoryStream : Stream
    {
        ...
        public static IWaveMemoryStreamProperties FromFile(string fileName)
        {
